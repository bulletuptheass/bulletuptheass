...
contract Dividends is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'TOKEN_NAME_HERE';
    string private constant _symbol = 'TOKEN_SYMBOL_HERE';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= TOKEN_SUPPLY_HERE * 10**_decimals;//equals 10000 token
    ...
    //DevWallets
    address public TeamWallet=payable(ADRESS_ONE_HERE);
    address public walletTwo=payable(ADDRESS_TWO_HERE);
    address public walletThree=payable(WALLET_THREE_HERE);
    address public walletFour=payable(WALLET_FOUR_HERE);
    //TestNet
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==TeamWallet||addr==walletTwo||addr==walletThree||addr==walletFour;
    }
